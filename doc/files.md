...
* hatch.conf: contains configuration settings for hatchd or hatch-qt
* hatchd.pid: stores the process id of hatchd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by hatchd or hatch-qt
