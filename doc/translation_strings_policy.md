...
This document provides guidelines for internationalization of the Hatch Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `hatch_en.ts` remains unchanged.
