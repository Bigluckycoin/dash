...
This mechanism has been integrated into Bitcore-Node-Hatch which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/hatchpay/insight-api-hatch#web-socket-api](https://github.com/hatchpay/insight-api-hatch#web-socket-api)
* API: [https://github.com/hatchpay/insight-api-hatch#instantsend-transactions](https://github.com/hatchpay/insight-api-hatch#instantsend-transactions)
...
By default, the Hatch Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Hatch Core daemon:
