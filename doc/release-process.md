...
space *do not upload these to the www.org server*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the www.org server

- Update www.org

- Announce the release:

  - Release on Hatch forum: https://www.www.org/forum/topic/official-announcements.54/

  - Optionally Discord, twitter, reddit /r/Hatchpay, ... but this will usually sort out itself

  - Notify flare so that he can start building [the PPAs](https://launchpad.net/~www.org/+archive/ubuntu/hatch)
