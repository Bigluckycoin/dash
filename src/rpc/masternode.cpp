...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Hatch address\n"
            "  payee          - Print the masternode payout Hatch address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Hatch address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "hatch",               "masternode",             &masternode,             true,  {} },
    { "hatch",               "masternodelist",         &masternodelist,         true,  {} },
    { "hatch",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "hatch",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
