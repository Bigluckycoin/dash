...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("hatch.org", "dnsseed.hatch.org"));
        vSeeds.push_back(CDNSSeedData("hatchdot.io", "dnsseed.hatchdot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "dnsseed.masternode.io"));
        vSeeds.push_back(CDNSSeedData("hatchpay.io", "dnsseed.hatchpay.io"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("hatchdot.io",  "testnet-seed.hatchdot.io"));
