...
// Copyright (c) 2014-2019 The Hatch Core developers
...
{
    const char* pszTimestamp = "I create my hatch 22/10/2018, its work! I hope this help all!";
    const CScript genesisOutputScript = CScript() << ParseHex("04c1ae63e2ffdd8d7a88853707a15b16d6e58f6937217730915b8f8516930407aee52ac0fdc2b31c6293e4485f24b6944c94ae2dcf9b0eb161e45210e32eda24f2") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP65Height = 158001; // 00000000000bc06e3d6fb0accc6292861a763fc0570d97f95c10a864c17c7818
        consensus.BIP66Height = 158001; // 00000000000bc06e3d6fb0accc6292861a763fc0570d97f95c10a864c17c7818
        consensus.DIP0001Height = 158002;
        consensus.DIP0003Height = 158002;
        consensus.DIP0003EnforcementHeight = 158002;
        consensus.DIP0003EnforcementHash = uint256S("000000000004d7f9b881629f7d67f79617452bb51960bce1596155853d267ade");
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Hatch: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Hatch: 2.5 minutes
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000001177ab45f3d6dece"); // 158152

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000000000006c67b9bb18379467adbc6630c86cffd017a6db045420686cde556"); // 158152
        ...
        vAlertPubKey = ParseHex("04c3afa45f6c475d7669e5749e98e722fad0b7498c9491caf133271ff0b5d8b12370c44282a94b21c827684ff05f559d255e76c43ab6cc299ad3c3cdb7a82bbac8");
        nDefaultPort = 8888;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1540220400, 638961, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000000fa6116f5d6c6ce9b60bd431469e40b4fe55feeeda59e33cd2f0b863196"));
        ...
        vSeeds.push_back(CDNSSeedData("hatchdot.ml", "dnsseed.hatchdot.ml"));
        vSeeds.push_back(CDNSSeedData("masternode.gq", "dnsseed.masternode.gq"));

        // Hatch addresses start with 'X'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,76);
        // Hatch script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Hatch private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,204);
        // Hatch BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        ...
        vSporkAddresses = {"Xu7PVuAZ3TXPsQ6kRoLLsvN5jXazMguazx"};
        nMinSporkKeys = 1;
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 45479, uint256S("0x000000000278a26de48ccfe81fa041837b063bb72897957fea494fa0440bcf75"))
            ( 55895, uint256S("0x00000000003cd4d49ea1f696b6375613dd9ac829507fe2893125abf71204225a"))
            ( 68899, uint256S("0x00000000000933d856ef38767758d48ebdcac33ce62b2777f3dbdacecb6b397f"))
            ( 74619, uint256S("0x000000000010dccdcb563a2d102caaff24a203b42c816cdfb90c34f53135e997"))
            ( 75095, uint256S("0x000000000041654054e002d9e739bd221e68c926cc8cc273406ec3497f8d4ed7"))
            ( 88805, uint256S("0x0000000003baf9d0bebfe710d3bf6ad0815d492dce2f806383edf5c444433247"))
            ( 107996, uint256S("0x000000003539851a27ad1ed217389401869331f2aed1ddc3ed2df0a6faebee54"))
            ( 137993, uint256S("0x000000000039fda10912643ada2de4c23daa5f12c1cb396b23192e18c5fdf823"))
            ( 158152, uint256S("0x000000000006c67b9bb18379467adbc6630c86cffd017a6db045420686cde556"))			
        };
...
public:
    CTestNetParams() {
        ...
        consensus.BIP34Hash = uint256S("0x00000543830169ac1e591c46d23167676aa17274c72496e1e28c7cec2062184f");
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000000000010601015"); // 261

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000a277ac76c3ad48bcf25524c79e9b78532fc09bc7fb6ed5da1820d4e6c90"); // 261

        pchMessageStart[0] = 0x7a;
        pchMessageStart[1] = 0xe3;
        pchMessageStart[2] = 0x9b;
        pchMessageStart[3] = 0xc5;
        vAlertPubKey = ParseHex("0489015fa9ccd6546470417820735013298b0591a82bafbb14efb7c44da73e420cac5aff9f975b11c37856a26929b1b496d1d50b752a2b78bbdcd557fe859baa79");
        nDefaultPort = 18888;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1540220401, 469389, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000bf8b02180fa3860e3f4fbfaab76db14fbfd1323d1d3ad06d83b828b6644"));
        assert(genesis.hashMerkleRoot == uint256S("0xed39d46b76da520fe092048c3025f05687936f8eaecef04cad63acd7e9825dd9"));
        ...
        vSeeds.push_back(CDNSSeedData("hatchdot.ml",  "testnet-seed.hatchdot.ml"));
        vSeeds.push_back(CDNSSeedData("masternode.gq", "test.dnsseed.masternode.gq"));

        // Testnet Hatch addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet Hatch script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Hatch BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Hatch BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet Hatch BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"yP7DvfqSnLLc57S7SWqgwoRvTVXp9hxRTc"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    261, uint256S("0x00000a277ac76c3ad48bcf25524c79e9b78532fc09bc7fb6ed5da1820d4e6c90"))
        };

        chainTxData = ChainTxData{
            1545466251, // * UNIX timestamp of last known number of transactions
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1540220402, 2, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5ad0eb674472fecdf980fbbaf569d500d3d143527e5d959afea0a90727040be4"));
        assert(genesis.hashMerkleRoot == uint256S("0xed39d46b76da520fe092048c3025f05687936f8eaecef04cad63acd7e9825dd9"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("hatchevo.org",  "devnet-seed.hatchevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x5ad0eb674472fecdf980fbbaf569d500d3d143527e5d959afea0a90727040be4"))
...
public:
    CRegTestParams() {
        ...
        // privKey:
        vSporkAddresses = {"yav5XL1QPWK8cbXehBaZ4pMLUf6BFcBPtM"};
        nMinSporkKeys = 1;
        ...
        // Regtest Hatch addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Hatch script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Hatch BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Hatch BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Hatch BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
