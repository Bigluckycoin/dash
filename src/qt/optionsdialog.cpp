    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("HATCH-light"), QVariant("light"));
    ui->theme->addItem(QString("HATCH-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("HATCH-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("HATCH-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("HATCH-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("HATCH-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("HATCH-traditional"), QVariant("trad"));
